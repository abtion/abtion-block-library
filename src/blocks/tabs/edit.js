...
function Edit({
  ...
  return (
    <div {...blockProps}>
      <div className="wp-block-abtion-block-library-tabs__navigation">
        <div className="wp-block-abtion-block-library-tabs__navigation-inner">
          ...
          <div className={`${navItemClassName} ${navItemClassName}--add`}>
            <Button
              ...
              onClick={() => {
                insertBlock(
                  createBlock('abtion-block-library/tab', {
                    label: __('Tab', 'abtion-block-library'),
                  }),
                  innerBlocks.length,
                  clientId
                );
